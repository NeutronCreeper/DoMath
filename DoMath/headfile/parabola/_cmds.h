...
void solveparabola(int flag){
    ...
    if(std::cin.good()){
        ...
        if(ch=='f'){
            ...
            }else throw "Not legal numbers!\n";
        }else throw "Not supported argument type expression!\n";
    }else throw "Not legal argument type!\n";
};
